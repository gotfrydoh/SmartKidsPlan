...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/list-caretakers.css" />
...
<body>
	...
	<div class="container" id="table-container">
		<div id="toolbar">
			<button id="add-caretaker-btn" type="button"
				class="btn btn-outline-primary"
				onclick="window.location.href='showFormForAdd'; return false;">Add
				Register</button>
			<button id="add-caretaker-btn" type="button"
				class="btn btn-outline-primary"
				onclick="window.location.href='updateList'; return false;">Update
				List</button>
			<button id="add-caretaker-btn" type="button"
				class="btn btn-outline-primary"
				onclick="window.location.href='setTeachersExtraHours'; return false;">Set
				Teachers</button>
		</div>
			...
			<tbody>
				<c:forEach var="tempRegister" items="${registers}">
					...
					<tr>
						...
						<td>${tempRegister.teacher.firstName}
							${tempRegister.teacher.lastName}</td>
						<td>
							...
							| <a href="${addTeacherLink}">Set Teacher</a> | <a
							href="${requestsLink}">Requests</a>
						</td>
	...
	<script>
		$('.mydatatable').DataTable({
			lengthMenu : [ [ 50, 100, 250,1000, -1 ], [ 50, 100, 250,1000, "All" ] ],
		});
	</script>
