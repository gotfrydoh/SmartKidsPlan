...
<body>
	...
	<form:form action="saveRequest" modelAttribute="request" method="POST"
		class="main-form needs-validation" novalidate="novalidate">
		...
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<form:input type="text" name="starttime" id="starttime" class="form-control"
						path="startTime" required="required" />
				...
				<div class="col">
					<div class="form-group">
						...
						<form:input type="text" name="endtime" id="endtime" class="form-control"
							path="endTime" required="required" />
		...
		<div class="form-group">
					...
					<form:input type="text" name="date" id="date" class="form-control"
						path="dateOfAttendance" required="required" />
		...
		<div class="form-group">
			...
			<form:select name="caretaker" path="caretaker.id" id="caretaker" class="form-control">
		...
		<a class="btn btn-primary"
			href="${pageContext.request.contextPath}/request/list"
			role="button">Back to list</a>
