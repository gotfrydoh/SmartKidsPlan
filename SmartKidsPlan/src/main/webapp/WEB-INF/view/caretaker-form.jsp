...
<link rel="stylesheet"
	...
	crossorigin="anonymous">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/caretaker-form.css">
</head>
...
<body>
	...
	<form:form action="saveCaretaker" modelAttribute="caretaker"
		method="POST" class="main-form needs-validation" novalidate="novalidate">
		...
		<div class="row">
			...
			<div class="col">
				<div class="form-group">
					...
					<form:input type="text" name="lastName" id="lastName"
						class="form-control" path="lastName" required="required" />
			...
			<div class="form-group">
					...
					<form:input type="text" name="pesel" id="pesel" class="form-control"
						path="pesel" required="required" />
						<div class="invalid-feedback">Please enter valid PESEL</div>
				</div>
				<div class="form-group">
		...
		<a class="btn btn-primary" href="${pageContext.request.contextPath}/caretaker/list" role="button">Back to list</a>
