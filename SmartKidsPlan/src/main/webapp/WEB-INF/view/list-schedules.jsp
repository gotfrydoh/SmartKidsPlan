...
<!-- Navigation -->
	...
	<div class="container" id="table-container">
		<div id="toolbar">
				<button id="add-caretaker-btn" type="button" class="btn btn-outline-primary" onclick="window.location.href='showFormForAdd'; return false;">Add Schedule</button>
		</div>
			...
			<tbody>
				<c:forEach var="tempSchedule" items="${schedules}">
					...
					<tr>
						...
						<td>${tempSchedule.teacher.firstName}
							${tempSchedule.teacher.lastName}</td>
						<td>
